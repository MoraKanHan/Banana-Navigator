...
<h3>Introduction</h3>
For this project, a Double DQN agent to navigate (and collect bananas!) in a large, square world.
...
# Instructions
Follow the instructions in Navigation.ipynb to get started with training Double DQN agent!
